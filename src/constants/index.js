import {
  ...
  const experiences = [
    ...
    },
    {
      ...
      points: [
        "I can build Rest API using Node.js Express.js MongoDB",
        "I've had the privilege of working on a wide range of projects, from data-driven applications to RESTful APIs. My expertise lies in designing robust database structures, optimizing data access, and ensuring seamless communication between the frontend and backend layers",
        // "Implementing responsive design and ensuring cross-browser compatibility.",
        // "Participating in code reviews and providing constructive feedback to other developers.",
      ],
    },
  ...
  const testimonials = [
    {
      testimonial:
        "I thought it was impossible to make a website as beautiful as our product, but Anwar proved me wrong.",
      name: "Sara Lee",
      designation: "CFO",
      company: "Acme Co",
    ...
    {
      testimonial:
        "I've never met a web developer who truly cares about their clients' success like Anwar does.",
      name: "Chris Brown",
      designation: "COO",
      company: "DEF Corp",
    ...
    {
      testimonial:
        "After Anwar optimized our website, our traffic increased by 50%. We can't thank them enough!",
      name: "Lisa Wang",
      designation: "CTO",
